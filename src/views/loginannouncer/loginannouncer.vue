<template><section class="vh-100 sooe">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form>
                    ...
                    <div class="pt-1 mb-4 ctb">
                      <button class="btn btn-dark btn-lg btn-block" type="button" ><a href="/registrationAnnouncer">Register Now</a></button>
                    </div>
...
export default{
    ...
    methods:{
        ...
        axios
        .post("http://127.0.0.1:8000/api/authannouncer",this.user)
        .then((response)=>{
      ...
      if(response.status=="200"){
        ...
        this.$router.push({name:"announcingpage"});
      }

      else if(response.status=="500"){
        alert(response.message);
        alert("incorrect username or password");
        this.$router.push({name:"loginannouncer"});
          // this.$router.back();
}

...
<header class="w3-display-container w3-content w3-center" style="max-width:1500px">
  <img class="w3-image" src="@/assets/arr.jpg" alt="Me" width="100" height="400">
  <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-black w3-center jklm">
    <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge">MEDIA UNIT</h1>
    <h5 class="w3-hide-large" style="white-space:nowrap">JANE DOE</h5>
    <h3 class="w3-hide-medium w3-hide-small">~Article~</h3>
  </div>
  
  <!-- Navbar (placed at the bottom of the header image) -->
  <div class="w3-bar w3-light-grey w3-round w3-display-bottommiddle w3-hide-small" style="bottom:-16px">
    <a href="/" class="w3-bar-item w3-button w3-text-black">Home</a>
    <a href="/photolio" class="w3-bar-item w3-button w3-text-black" >Portfolio</a>
...
<div class="w3-row-padding bgb">
    <div class="w3-third w3-container w3-margin-bottom" v-for="values in post_data" :key="values.id">
      <img :src="values.url" style="width:100%" alt="peera">
      <div class="w3-container w3-white">
        <p><b>{{values.title}}</b></p>
 ...
 import axios from "axios";
  export default{
    ...
    methods:{
      get_post_data(){
        axios
        .get("http://127.0.0.1:8000/api/getArticleImages")
        .then((response)=>{
          {

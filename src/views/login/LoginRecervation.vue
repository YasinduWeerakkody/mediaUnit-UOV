<template><section class="vh-100 seee" >
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form>
                    ...
                    <div class="pt-1 mb-4 ctb">
                      <button class="btn btn-dark btn-lg btn-block" type="button" @click="login()"><a href="/recervationRegistration">Register Now</a></button>
                    </div>
...
export default{
    ...
    methods:{
        ...
        axios
        .post("http://127.0.0.1:8000/api/authenticate",this.user)
        .then((response)=>{
            ...
            if(response.data.status=="200"){
                ...
                this.$router.push({name:"requestReservation"});
            }
            else if(response.data.status=="500"){
                alert("incorrect username or password");
                this.$router.push({name:"LoginRecervation"});
                // this.$router.back();
            }
        })
...
.seee{
    background-image:url('@/assets/1472.jpeg');

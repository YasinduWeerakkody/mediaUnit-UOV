...
<nav>
  ...
  <ul>
    ...
    <li>
      <a href="/LoginRecervation" class="link"> Reservation </a>
    </li>

    <li>
      <a href="/joinLogin" class="cta"> JOIN OUR TEAM </a>
    </li>
  </ul>
</nav>
<section>
  <article>
    <ul class="panels">
      ...
      <li class="panel">
        ...
        <img src="@/assets/11.jpg" alt="Marthin Luther King" />
      </li>
      <li class="panel">
        <a href="/front">
          <span>
        ...
        <img src="@/assets/12.jpeg" alt="image of spaceship" />
      </li>
      <li class="panel">
        <a href="/annoncing">
          <span>
        ...
        <img src="@/assets/123.jpg" alt="image of hot air balloons" />
      </li>
